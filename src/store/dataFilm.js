       ...
       film :  [
            {
              ...
              "Sinopsis": "  Dua puluh tiga hari setelah peristiwa itu, Captain Marvel menyelamatkan Tony Stark dan Nebula dari luar angkasa. Mereka pun bergabung dengan para Avengers yang tersisa. Para Avengers tersebut kemudian membuat misi untuk mengambil infinity stone dari Thanos, namun Thanos telah menghancurkannya. Thor yang marah kemudian membunuh Thanos.\n  Lima tahun setelah peristiwa yang disebut blip itu terjadi, orang-orang yang ditinggalkan masih merasakan kehilangan yang amat dalam, tak terkecuali para Avengers yang tersisa. Meski begitu, mereka pun mulai berusaha menjalani kehidupan masing-masing, Tony Stark hidup bahagia bersama Pepper Potts dan telah memiliki seorang putri.\n  \n  Thor menghabiskan waktunya untuk mabuk dan menonton TV. Sementara Steve Rogers dan Natasha Romanoff tetap berada di markas mereka. Harapan baru muncul saat Scott Lang atau Ant Man keluar dari dunia quantum realm. Scott Lang yang kaget dengan keadaan dunia dan putrinya yang menghilang pun bertemu dengan para Avengers.\n  Scott Lang kemudian meyakinkan Avengers bahwa teori quantum realm memungkinkan mereka untuk melakukan perjalanan waktu dan mengambil infinity stone sebelum dicuri oleh Thanos. Tony Stark , Bruce Banner, dan Rocket kemudian membuat sebuah mesin waktu. Mereka kemudian membentuk tim untuk menyebar dan mengambil infinity stone di berbagai tempat tersebut.",
              "Gambar": {
                nama : "Avengers_Endgame_poster.jpg",
                isi : "https://upload.wikimedia.org/wikipedia/id/0/0d/Avengers_Endgame_poster.jpg"
              }
            },
            {
              "id" : 2,
            ...
            },
            {
              ...
              "Gambar": {
                nama : "Titanic_%28Official_Film_Poster%29.png",
                isi : "https://upload.wikimedia.org/wikipedia/id/1/19/Titanic_%28Official_Film_Poster%29.png"
              }
            }, {
              "id" : 4,
              ...
              `,
              "Gambar": {
                nama : "Hotel_Transylvania_Transformania.jpg",
                isi : "https://upload.wikimedia.org/wikipedia/en/8/8b/Hotel_Transylvania_Transformania.jpg"
              }
