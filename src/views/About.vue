...
<div>
    ...
    <div class="abgroup">
        <div class="abitem">
            <h5>Git Hub</h5>
            <a class="gamicon" @click="redirect('https://github.com/Frasydi')">
        ...
        <div class="abitem">
            <h5>Discord</h5>
            <a class="gamicon" @click="redirect('https://discordapp.com/users/340984372804976640')">
        ...
        <div class="abitem">
            <h5>Instagram</h5>
            <a class="gamicon" @click="redirect('https://www.instagram.com/ahmad_sydiq/')">
